      ...
      <el-main>
        ...
        <div v-if="stepActive === 1">
          <div class="register-wrap">
            <el-radio v-model="org.orgType" label="1">企业法人</el-radio>
            <el-radio v-model="org.orgType" label="2">社会团体</el-radio>
            <el-radio v-model="org.orgType" label="3">事业法人</el-radio>
          </div>
        </div>
            ...
            <el-row type="flex" justify="center">
              <el-form ref="loginForm" :model="user" status-icon label-width="80px">
                <el-form-item prop="accountPhone" label="手机号码">
                  <el-input v-model="org.orgPhone" placeholder="请输入手机号码"></el-input>
                </el-form-item>
                <el-form-item prop="password" label="密码">
                  <el-input v-model="org.passwd" show-password placeholder="请输入密码"></el-input>
                </el-form-item>
                <el-form-item prop="repassword" label="确认密码">
                  <el-input v-model="org.repasswd" show-password placeholder="请再次输入密码"></el-input>
                </el-form-item>
              </el-form>
            </el-row>
          </div>
            ...
            <el-form class="company" ref="loginForm" :model="user" status-icon label-width="80px">
              <el-row type="flex" justify="center">
                <el-form-item label="企业名">
                  <el-input v-model="org.orgName" placeholder="请输入企业名称"></el-input>
                </el-form-item>
                <el-form-item label="常用联系人1">
                  <el-input v-model="org.linkmanOne" placeholder="姓名"></el-input>
                </el-form-item>
              </el-row>
              <el-row type="flex" justify="center">
                <el-form-item label="企业简称">
                  <el-input v-model="org.orgSimpleName" placeholder="企业简称"></el-input>
                </el-form-item>
                <el-form-item label="常用联系人1-手机">
                  <el-input v-model="org.linkmanOnePhone" placeholder="手机号码"></el-input>
                </el-form-item>
              </el-row>
              <el-row type="flex" justify="center">
                <el-form-item label="企业注册地址">
                  <el-input v-model="org.registerAddress" placeholder="请输入企业注册地址"></el-input>
                </el-form-item>
                <el-form-item label="常用联系人2">
                  <el-input v-model="org.linkmanTwo" placeholder="姓名"></el-input>
                </el-form-item>
              </el-row>
              <el-row type="flex" justify="center">
                <el-form-item label="企业常用地址">
                  <el-input v-model="org.oftenAddress" placeholder="请输入企业常用地址"></el-input>
                </el-form-item>
                <el-form-item label="常用联系人2-手机">
                  <el-input v-model="org.linkmanTwoPhone" placeholder="请输入手机号码"></el-input>
                </el-form-item>
              </el-row>
              <el-row type="flex" justify="center">
                <el-form-item label="是否有境外投资">
                  <el-select v-model="org.isInvestAbroad" placeholder="活动区域">
                    <el-option label="是" value="是"></el-option>
                    <el-option label="否" value="否"></el-option>
                  </el-select>
                </el-form-item>
                <el-form-item label="培训类别">
                  <el-select v-model="org.trainType" placeholder="请选择">
              ...
              <el-row type="flex" justify="center">
                <el-form-item label="统一社会信用代码">
                  <el-input v-model="org.unifiedCode" placeholder="请输入..."></el-input>
                </el-form-item>
                <el-form-item label="资质类别">
                  <el-select v-model="org.qualificationCategory" placeholder="请选择">
              ...
              <el-row type="flex" justify="center">
                <el-form-item label="企业电话">
                  <el-input v-model="org.orgPhone" placeholder="请输入..."></el-input>
                </el-form-item>
                <el-form-item label="场地性质">
                  <el-select v-model="org.siteProperties" placeholder="请选择">
            ...
            >
              <el-row type="flex" justify="center">
                <el-form-item label="法人代表">
                  <el-input v-model="org.legalRepresentName" placeholder="姓名"></el-input>
                </el-form-item>
              </el-row>

              <el-row type="flex" justify="center">
                <el-form-item label="联系方式">
                  <el-input v-model="org.legalRepresentPhone" placeholder="手机号码"></el-input>
                </el-form-item>
              </el-row>

              <el-row type="flex" justify="center">
                <el-form-item label="证件类型">
                  <el-radio v-model="org.idType" label="1">中国居民身份证</el-radio>
                  <el-radio v-model="org.idType" label="2">港澳居民来往内地通行证</el-radio>
                  <el-radio v-model="org.idType" label="3">台湾居民来往大陆通行证</el-radio>
                  <el-radio v-model="org.idType" label="4">护照</el-radio>
                  <el-radio v-model="org.idType" label="5">外国人永居留身份证</el-radio>
                  <el-radio v-model="org.idType" label="6">港澳台居住证</el-radio>
                </el-form-item>
              </el-row>

              <el-row type="flex" justify="center">
                <el-form-item label="证件号码">
                  <el-input v-model="org.idNum" placeholder="证件号"></el-input>
                </el-form-item>
              </el-row>
...
export default {
  ...
  methods: {
    ...
    toLogin() {
      ...
      this.org.idCardFront = imageArray[0].raw;
      this.org.idCardReverse = imageArray[1].raw;
